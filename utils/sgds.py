...
# https://github.com/zeke-xie/stable-weight-decay-regularization/blob/e0abb1d/swd_optim/sgds.py#L6
class SGDS(Optimizer):
    r"""Implements stochastic gradient descent with stable weight decay (SGDS).
    It has be proposed in `Stable Weight Decay Regularization`__.
